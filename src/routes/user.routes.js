...
import { createUser, getUserById, updateUser, getAllUsers, getModulesByUser, getReportsByUser, addAllData, createUserModule, createUserReport, deleteUserModule, deleteUserReport } from "../controllers/user.controller.js"
